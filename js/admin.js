...
const Admin = (function() {
  ...
  // Пути даны относительно /pages/ (т.е. как ссылки на страницы внутри папки pages/)
  const DEFAULT_ARTICLES = [
    { id: 'education', badge: 'Образование', badgeClass: 'badge-edu', isNew: true, headline: 'Как GPT-модели меняют обучение', description: 'Персональные объяснения, автогенерация заданий, адаптивные траектории. Почему ИИ уже стал частью учебного процесса и что это меняет для студентов.', href: 'article-education.html' },
    { id: 'python', badge: 'Python', badgeClass: 'badge-dev', isNew: true, headline: 'Зачем учить Python в 2026 году', description: 'Python — самый популярный язык по индексу TIOBE уже третий год подряд. Разбираемся, почему он стал стандартом в ИИ, аналитике и автоматизации.', href: 'article-python.html' },
    { id: 'prompt', badge: 'Разработка', badgeClass: 'badge-dev', isNew: false, headline: 'Prompt Engineering без магии', description: 'Промт — это интерфейс к модели. Как формулировать задачу, чтобы ИИ отвечал стабильно, а не случайно.', href: 'article-prompt.html' },
    { id: 'creative', badge: 'Креатив', badgeClass: 'badge-creative', isNew: false, headline: 'Нейросети и творчество: кто тут автор?', description: 'Генеративная графика, музыка, синтез голоса. Как ИИ помогает создавать быстрее, не убивая личный почерк автора.', href: 'article-creative.html' },
    { id: '3d', badge: '3D', badgeClass: 'badge-creative', isNew: false, headline: 'ИИ в 3D-моделировании: новая эра дизайна', description: 'NVIDIA Omniverse, Blender с ИИ-плагинами, генерация текстур и мешей. Как нейросети ускоряют работу 3D-художников и снижают порог входа.', href: 'article-3d.html' },
    { id: 'webdev', badge: 'Веб', badgeClass: 'badge-biz', isNew: false, headline: 'HTML, CSS, JS: почему веб-разработка — это суперсила', description: 'Веб-технологии лежат в основе всего: от лендингов до сложных приложений. Почему стоит начать именно с них и как ИИ помогает учиться быстрее.', href: 'article-webdev.html' },
    { id: 'learning', badge: 'Обучение', badgeClass: 'badge-edu', isNew: false, headline: 'Как учиться программированию с помощью ИИ', description: 'Чат-боты объясняют код, генерируют задания и дают мгновенную обратную связь. Практические советы, как использовать ИИ для обучения, а не для списывания.', href: 'article-learning.html' }
  ];
